        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card h-100">
                    <div class="card-body">
                        <form action="editarCliente.php?nif=<?php echo $nif ?>" method="POST" class="form-group pb-2">
                            ...
                            <div class="form-group pb-2">
                                <input type="text" id="direccion" name="direccion" class="form-control" maxlength="50"
                                    placeholder="Direccion" value="<?php echo $direccion ?>" required>
                            </div>
                            <div class="form-group pb-2">
                            ...
                            <div class="form-group pb-2">
                                <input type="date" id="fecha_alta" name="fecha_alta" class="form-control" maxlength="50"
                                    placeholder="Fecha de alta" value="<?php echo $fecha_alta ?>" required>
                            </div>
